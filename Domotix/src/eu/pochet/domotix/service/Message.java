...
{	
	...
	public String getData() 
	{
		return new StringBuilder()
		    .append(cardAddress)
			.append(fromCardAddress)
			.append("0000")
		    .append(function)
		    .append(cardAddress)
		    .append(registerNb)
		    .append(registerValue)
			.toString();
	}
	
	/*public static final String ACTION = "ACTION";
	public static final String CARD_NB = "CARD_NB";
	public static final String LIGHT_NB = "LIGHT_NB";
