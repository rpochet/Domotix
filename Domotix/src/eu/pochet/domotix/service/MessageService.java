...
public class MessageService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		String domotixIncomingBusHost = (String) intent.getCharSequenceExtra("domotixIncomingBusHost");
		if(domotixIncomingBusHost == null) {
			domotixIncomingBusHost = "192.168.1.4";
		}
		int domotixIncomingBusPort = intent.getIntExtra("domotixIncomingBusPort", 5555);
