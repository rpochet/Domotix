...
public class Stream {
     ...
     * @param port
     * @param secure
     * @param path /engine.io/default/
     * @param transport websocket
     */
    public Stream(Context context, String host, int port, boolean secure, String path, String transport) {
        String connection = String.format("%s://%s:%d%s?transport=%s", secure ? "wss" : "ws", host, port, path, transport);
